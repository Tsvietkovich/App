package com.tsvietkovich.Samlpe3;
...
public class App {
    public static void main( String[] args ) {
        ...
        try {
            ...
            Query query = em.createQuery("SELECT c FROM Clients c WHERE c.age < 5", Client.class);
            ...
            query = em.createQuery("SELECT c FROM Courses c", Course.class);
            ...
            try {
                query = em.createQuery("SELECT c FROM Courses c WHERE c.name = :name", Course.class);
